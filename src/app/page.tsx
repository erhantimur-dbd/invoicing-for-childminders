            ...
            <div className="flex items-start gap-3">
              ...
              <div className="w-56 rounded-2xl overflow-hidden shadow-2xl shadow-black/50 ring-1 ring-white/20 flex-shrink-0">
                ...
                <div className="flex items-center gap-2.5 px-3 py-2.5" style={{ background: 'linear-gradient(135deg, #075E54 0%, #128C7E 100%)' }}>
                  ...
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-emerald-300 to-sky-400 flex items-center justify-center flex-shrink-0 ring-2 ring-white/25 shadow">
                    <span className="text-white font-extrabold text-[10px] leading-none">D.</span>
                  </div>
                ...
                <div className="px-3 py-3 space-y-2" style={{ background: '#ECE5DD' }}>
                  ...
                  <div className="flex items-end gap-1.5">
                    ...
                    <div className="relative max-w-[85%]">
                      ...
                      <div className="bg-white rounded-xl rounded-tl-none px-3 py-1.5 shadow-sm">
                        ...
                        <p className="text-gray-800 text-xs leading-snug">Hi! I&apos;m Dottie 👋 Your invoicing is sorted.</p>
                  ...
                  <div className="flex items-end gap-1.5">
                    ...
                    <div className="relative max-w-[85%]">
                      <div className="bg-white rounded-xl rounded-tl-none px-3 py-1.5 shadow-sm">
                        <p className="text-gray-800 text-xs leading-snug">Invoice for Olivia Bennett is ready ✨ £192.50 — approve to send!</p>
