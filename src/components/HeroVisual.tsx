    ...
    <div className="hidden lg:flex justify-center items-center">
      <div className="flex items-start gap-3">
        ...
        <div className="flex flex-col flex-shrink-0">
          <div className="w-56 rounded-2xl overflow-hidden shadow-2xl shadow-black/50 ring-1 ring-white/20">
                ...
                <div className="flex justify-end">
                  <div className="relative max-w-[80%]">
                    ...
                    <div className="rounded-xl rounded-tr-none px-3 py-1.5 shadow-sm" style={{ background: '#DCF8C6' }}>
                      ...
                      <div className="flex items-center justify-end gap-1 mt-0.5">
                        <span className="text-gray-400 text-[9px]">9:44 AM</span>
                        <svg width="12" height="9" viewBox="0 0 12 10" fill="none" className="text-gray-400" aria-hidden="true">
                          <path d="M11 1L4 9.5L1 6.5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                      </div>
                    </div>
                  </div>
          ...
          {/* Replay button */}
          <div className={`flex justify-center transition-opacity duration-500 ${step >= 5 ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
            <button
              type="button"
              onClick={handleReplay}
              className="flex items-center gap-1.5 text-[10px] text-white/50 hover:text-white/80 transition-colors mt-1.5"
          ...
          <div className="relative flex-shrink-0">
            ...
            <div className="relative bg-white rounded-3xl shadow-2xl shadow-black/30 p-6 w-72 text-sm">
              ...
              <div className="space-y-2 mb-4">
                <div className="flex justify-between"><span className="text-gray-600">Mon · Full day</span><span className="font-medium text-gray-900">£55.00</span></div>
                <div className="flex justify-between"><span className="text-gray-600">Tue · Full day</span><span className="font-medium text-gray-900">£55.00</span></div>
                <div className="flex justify-between"><span className="text-gray-600">Wed · Half day</span><span className="font-medium text-gray-900">£27.50</span></div>
                <div className="flex justify-between"><span className="text-gray-600">Thu · Full day</span><span className="font-medium text-gray-900">£55.00</span></div>
              </div>
              <div className="h-px bg-gray-100 mb-3" />
              <div className="flex justify-between font-bold text-gray-900 text-base">
                <span>Total</span><span>£192.50</span>
              </div>
              <div className="mt-4 flex gap-2">
                <button className="flex-1 py-2 rounded-xl bg-emerald-600 text-white text-xs font-semibold">Pay now</button>
